...
import SettingStatusSubTable from "./Table_SettingStatus";
...
export default function Setting_NCStatus() {
    ...
    const permission = userInfo?.permissions?.Setting_NCstatus;
        ...
        <Stack direction='column' mx='5%'>
            ...
            <Box className="layoutContent" mt={2} mb={3}>
                {<SettingStatusSubTable data={filteredData} isEdit={isEdit} editedStatus={editedStatus}
                    onTriggerEdit={handleTriggerEdit} setEditedStatus={setEditedStatus} canEdit={canEdit} />}
            </Box>
        </Stack>
    );
}
