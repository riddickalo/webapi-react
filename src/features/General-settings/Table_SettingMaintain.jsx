...
import { MaintainEnabledIcon, EditMaintainButton, SaveMaintainItemButton, DeleteMaintainItemButton } from "../../shared/components/Icons";
import { StyledSubTable, StyledTableCell, StyledTableRow } from "../../shared/components/StyledTable";

export default function SettingMaintainSubTable({ data, isEdit, editItem, handleTrigger, handleChange, canEdit = false }) {
                    ...
                    <StyledTableRow key={row.sn}>
                        ...
                        <StyledTableCell align='center'>
                            {(isEdit === row.sn)? 
                                ...
                                <EditMaintainButton id={`Edit-${row.sn}`} onClick={handleTrigger} canEdit={canEdit} />}
                        </StyledTableCell>
                    </StyledTableRow>
            )));
        }
