...
import NC_Status from './pages/NC_Status';
import NC_Maintain from './pages/NC_Maintain';
import NC_File from './pages/NC_File';
import NC_Utilize from './pages/NC_Utilize';
import Alarm_Status from './pages/Alarm_Status';
import Alarm_History from './pages/Alarm_History';
import Order from './pages/Order';
import Report from './pages/Report';
import Setting_Item from './pages/Setting_Item';
import Setting_Maintain from './pages/Setting_Maintain';
import Setting_NCStatus from './pages/Setting_NCstatus';
import Setting_PPmap from './pages/Setting_PPmap';
import Sys_Account from './pages/Sys_Account';
import Sys_General from './pages/Sys_General';
import Sys_Notification from './pages/Sys_Notification';
import TestPage from './pages/theme';
